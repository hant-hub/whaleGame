...
#create test enemy
for x in range(10):
	objects.append(enemies.Enemy(pos = (screen.width/2, screen.height/2 - 100*x), size = (50,25), speed = 1, player = player, objects = objects, handler = handler, camera = camera, batch = batch))
